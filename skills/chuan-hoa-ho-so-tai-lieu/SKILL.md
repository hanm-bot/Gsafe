...
Năm dạng báo cáo chuẩn, quy tắc chọn dạng, kỹ thuật xuất PDF/Excel và bước quét `grep` xác minh: theo `sht-nen-tang-kiem-chung` §6. Không định nghĩa lại ở đây. Nếu đầu ra là **văn bản hành chính đối ngoại** (công văn), chấm thêm giọng theo rubric văn phong người thật §6.3 và để nguồn ở file `.nguon.md` kèm.
