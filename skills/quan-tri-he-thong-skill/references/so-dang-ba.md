...
|---|---|---|---|---|
| `sht-nen-tang-kiem-chung` | **0** | Lan truyền hiệu chỉnh · đổi tên hàng loạt an toàn (+ cụm bảo vệ) · một-bản-có-hiệu-lực · **ghi đúng thư mục đích (§3.1)** · đặt câu hỏi ngược với nguồn · checklist bàn giao chung · **kết xuất theo người đọc (5 dạng báo cáo, xuất PDF/Excel, quét `grep` xác minh)** | **Mọi** skill tầng 1 — nạp kèm trong mọi phiên có bàn giao file | Nghiệp vụ cụ thể của bất kỳ miền nào |
| `quan-tri-he-thong-skill` | **0** | Ranh giới giữa các skill, audit, phân tầng, quy trình nâng cấp, Sổ đăng bạ | `skill-creator` để viết nội dung bên trong một skill | Nội dung nghiệp vụ bên trong từng skill |
